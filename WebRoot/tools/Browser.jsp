...
<%@page import="java.util.*,
                ...
                java.text.*,
                java.util.zip.*,
                java.io.*,tj.common.config.ApplicationConfig"
%>
<%!
    //FEATURES
	...
	*/
	...
	//private static String localAddr = getLocalAddr();
	...
	private String getLocalAddr() throws Exception{
		String name = null;
...
<%
		...
		final String browser_name = ApplicationConfig.getDomainName() + requestUri;
...
%></textarea>
	...
	<hr>
	<center>
		<small>jsp File Browser version <%= VERSION_NR%> by <a href="http://www.vonloesch.de">www.vonloesch.de</a><%=localAddr %></small>
	</center>
	</center>
</body>
</html>
